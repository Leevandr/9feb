...
class Ui_BuyerForm(object):
    def setupUi(self, BuyerForm):
        ...
        self.price_min = QtWidgets.QSpinBox(self.catalog_tab)
        ...
        self.price_max = QtWidgets.QSpinBox(self.catalog_tab)
        ...
        self.catalog_layout.addLayout(self.cat_filter_2)
        ...
        self.cart_total_label = QtWidgets.QLabel("Итого: 0 руб", self.cart_tab)
        font = QtGui.QFont()
        ...
        self.profile_email = QtWidgets.QLabel("E-mail: ", self.profile_tab)
