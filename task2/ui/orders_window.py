...
class OrdersWindow(QWidget):
    def __init__(self, role, parent_window):
        ...
        self.setWindowTitle('Заказы — МебельДом')
        self.resize(720, 520)
    ...
    def _create_order_card(self, order):
        ...
        card.setStyleSheet(
            'QFrame#order_card { background: #FFF8F0; '
        ...
        article_label.setStyleSheet(
            'font-weight: bold; font-size: 14px; color: #4E342E;')
        ...
        color = status_colors.get(status, '#5D4037')
        ...
        addr_label.setStyleSheet('font-size: 12px; color: #5D4037;')
    ...
    def delete_selected_order(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            ...
            self.refresh_orders()
            QMessageBox.information(
                self, 'Успех', f'Заказ #{order_id} удалён.')
