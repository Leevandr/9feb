...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        self.manufacturer_combo = QtWidgets.QComboBox(parent=MainForm)
        self.manufacturer_combo.setObjectName("manufacturer_combo")
        self.filter_panel.addWidget(self.manufacturer_combo)
    ...
    def retranslateUi(self, MainForm):
        ...
        MainForm.setWindowTitle(_translate("MainForm", "Каталог мебели"))
        ...
        self.search_edit.setPlaceholderText(_translate("MainForm", "Поиск по названию, описанию, материалу..."))
